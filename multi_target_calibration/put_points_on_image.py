...
#      # If it's a ROS2 PointCloud2 message
#     if isinstance(point_cloud, pc2):
...
#         else:
#             # pad fake intensity if missing
#             intensity = np.ones((point_cloud.shape[0], 1))
#             points = np.hstack((point_cloud, intensity))
#     else:
#         raise TypeError("point_cloud must be a PointCloud2 or Nx4 numpy array")
